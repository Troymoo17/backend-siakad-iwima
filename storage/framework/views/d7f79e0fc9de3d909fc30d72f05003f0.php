...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('username')); ?>" placeholder="Username admin" required autofocus>
                        </div>
                    </div>
                    <div class="mb-4">
                ...
                <p class="text-center text-muted mt-3 small">
                    Institut Widya Pratama Pekalongan &copy; <?php echo e(date('Y')); ?>
...
<?php /**PATH E:\kuliah\smt7\siakad test\siakad\siakad_backend_fix\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>