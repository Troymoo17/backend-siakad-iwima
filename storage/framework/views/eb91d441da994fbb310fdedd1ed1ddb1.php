<?php $__env->startSection('title','Keuangan'); ?> <?php $__env->startSection('page-title','Tagihan & Pembayaran'); ?>
        ...
        <div class="stat-card" style="background:linear-gradient(135deg,#dc3545,#c82333)">
            <div class="d-flex justify-content-between align-items-center">
                <div><p class="mb-1 small opacity-75">Total Belum Bayar</p>
                    <h4 class="fw-bold mb-0">Rp <?php echo e(number_format($stats['total_belum'],0,',','.')); ?></h4>
                    <small class="opacity-75"><?php echo e($stats['count_belum']); ?> tagihan</small></div>
        ...
        <div class="stat-card" style="background:linear-gradient(135deg,#28a745,#1e7e34)">
            <div class="d-flex justify-content-between align-items-center">
                <div><p class="mb-1 small opacity-75">Total Sudah Lunas</p>
                    <h4 class="fw-bold mb-0">Rp <?php echo e(number_format($stats['total_lunas'],0,',','.')); ?></h4></div>
...
<div id="bulkModal" class="d-none mb-3">
    <div class="card border-warning">
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.keuangan.tagihan.bulk')); ?>" class="row g-3">
                <?php echo csrf_field(); ?>
                ...
                <div class="col-md-2"><label class="form-label fw-semibold">Jenis</label>
                    <select name="jenis_tagihan" class="form-select" required>
                        <?php $__currentLoopData = ['UKP','SKS','Denda','Lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="nim-search-box mb-3">
    <div class="d-flex gap-2 align-items-end flex-wrap">
        ...
        <?php if(request('nim')): ?><a href="<?php echo e(route('admin.keuangan.index')); ?>" class="btn btn-light">Reset</a><?php endif; ?>
    </div>
</div>
...
<div class="row g-3">
    ...
    <div class="col-lg-4">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('admin.keuangan.tagihan.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-2"><label class="form-label fw-semibold">NIM</label>
                        <input type="text" name="nim" id="nimTagihan" class="form-control" value="<?php echo e(old('nim', request('nim'))); ?>" required placeholder="22.240.0001">
                        <div id="nimTagihanInfo" class="mt-1"></div></div>
                    <div class="row g-2 mb-2">
                        <div class="col-6"><label class="form-label fw-semibold">Jenis Tagihan</label>
                            <select name="jenis_tagihan" class="form-select" required>
                                <?php $__currentLoopData = ['UKP','SKS','Denda','Lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($j); ?>" <?php echo e(old('jenis_tagihan')===$j?'selected':''); ?>><?php echo e($j); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select></div>
                    ...
                    <div class="mb-2"><label class="form-label fw-semibold">Nominal (Rp)</label>
                        <input type="number" name="nominal_tagihan" class="form-control" value="<?php echo e(old('nominal_tagihan')); ?>" placeholder="3500000" required></div>
                    ...
                    <div class="mb-2"><label class="form-label fw-semibold">Jatuh Tempo</label>
                        <input type="date" name="tanggal_jatuh_tempo" class="form-control" value="<?php echo e(old('tanggal_jatuh_tempo')); ?>"></div>
                    <div class="mb-2"><label class="form-label fw-semibold">Deskripsi</label>
                        <input type="text" name="deskripsi" class="form-control" value="<?php echo e(old('deskripsi')); ?>" placeholder="Keterangan tagihan"></div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('admin.keuangan.pembayaran.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-2"><label class="form-label fw-semibold">NIM</label>
                        <input type="text" name="nim" class="form-control" value="<?php echo e(old('nim', request('nim'))); ?>" required placeholder="22.240.0001"></div>
                    <div class="mb-2"><label class="form-label fw-semibold">ID Tagihan</label>
                        <input type="number" name="tagihan_id" class="form-control" value="<?php echo e(old('tagihan_id')); ?>" required placeholder="Lihat ID di tabel tagihan"></div>
                    <div class="mb-2"><label class="form-label fw-semibold">Jumlah Bayar (Rp)</label>
                        <input type="number" name="jumlah_bayar" class="form-control" value="<?php echo e(old('jumlah_bayar')); ?>" required></div>
                    <div class="mb-2"><label class="form-label fw-semibold">Tanggal Bayar</label>
                        <input type="date" name="tanggal_bayar" class="form-control" value="<?php echo e(old('tanggal_bayar', date('Y-m-d'))); ?>" required></div>
                    <div class="mb-2"><label class="form-label fw-semibold">Metode</label>
                        <select name="metode" class="form-select" required>
                            <?php $__currentLoopData = ['Transfer','Virtual Account','Tunai','Lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($m); ?>" <?php echo e(old('metode')===$m?'selected':''); ?>><?php echo e($m); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select></div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header"><i class="fas fa-list me-2"></i>Data Tagihan (<?php echo e($tagihans->total()); ?>)</div>
            <div class="card-body">
                <form method="GET" class="row g-2 mb-3">
                    ...
                    <div class="col-md-3"><select name="status_bayar" class="form-select form-select-sm">
                        ...
                        <?php $__currentLoopData = ['Belum','Lunas','Cicilan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($s); ?>" <?php echo e(request('status_bayar')===$s?'selected':''); ?>><?php echo e($s); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select></div>
                    <div class="col-md-3"><select name="jenis_tagihan" class="form-select form-select-sm">
                        <option value="">Semua Jenis</option>
                        <?php $__currentLoopData = ['UKP','SKS','Denda','Lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($j); ?>" <?php echo e(request('jenis_tagihan')===$j?'selected':''); ?>><?php echo e($j); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select></div>
                    <div class="col-md-2"><input type="number" name="semester" class="form-control form-control-sm" placeholder="Semester" value="<?php echo e(request('semester')); ?>"></div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $tagihans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="<?php echo e($t->status_bayar==='Belum' && $t->tanggal_jatuh_tempo && $t->tanggal_jatuh_tempo < date('Y-m-d') ? 'table-danger' : ''); ?>">
                            <td><small class="text-muted">#<?php echo e($t->id); ?></small></td>
                            <td>
                                <strong><?php echo e($t->nim); ?></strong><br>
                                <small class="text-muted"><?php echo e($t->mahasiswa?->nama); ?></small>
                            </td>
                            <td><span class="badge bg-secondary"><?php echo e($t->jenis_tagihan); ?></span><br>
                                <small class="text-muted"><?php echo e($t->deskripsi); ?></small></td>
                            <td class="fw-semibold">Rp <?php echo e(number_format($t->nominal_tagihan,0,',','.')); ?></td>
                            <td><?php echo e($t->semester); ?></td>
                            <td>
                                <?php $colors = ['Belum'=>'danger','Lunas'=>'success','Cicilan'=>'warning']; ?>
                                <span class="badge bg-<?php echo e($colors[$t->status_bayar]??'secondary'); ?>"><?php echo e($t->status_bayar); ?></span>
                                <?php if($t->pembayaran->count()): ?>
                                <br><small class="text-success">Bayar: Rp <?php echo e(number_format($t->pembayaran->sum('jumlah_bayar'),0,',','.')); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($t->tanggal_jatuh_tempo): ?>
                                <small class="<?php echo e($t->tanggal_jatuh_tempo < date('Y-m-d') && $t->status_bayar==='Belum' ? 'text-danger fw-bold' : 'text-muted'); ?>">
                                    <?php echo e(\Carbon\Carbon::parse($t->tanggal_jatuh_tempo)->format('d/m/Y')); ?>

                                </small>
                                <?php else: ?> <small class="text-muted">-</small> <?php endif; ?>
                            </td>
                            <td>
                                <form action="<?php echo e(route('admin.keuangan.tagihan.destroy',$t->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Hapus tagihan?')">
                ...
                <?php echo e($tagihans->links('pagination::bootstrap-5')); ?>
...
document.getElementById('nimTagihan').addEventListener('blur', function() {
    ...
    fetch('<?php echo e(route("admin.keuangan.search-mhs")); ?>?nim='+encodeURIComponent(nim), {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\kuliah\smt7\siakad test\siakad\siakad_backend_fix\resources\views/admin/keuangan/index.blade.php ENDPATH**/ ?>